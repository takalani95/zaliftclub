...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Search for available trips' }),
    (0, swagger_1.ApiQuery)({ name: 'from', example: 'Cape Town' }),
    (0, swagger_1.ApiQuery)({ name: 'to', example: 'Johannesburg' }),
    (0, swagger_1.ApiQuery)({ name: 'date', example: '2024-12-25', required: false }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get my trips (driver)' }),
...
__decorate([
    ...
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Create a new trip (drivers only)' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
